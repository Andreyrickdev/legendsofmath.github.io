const buttonGreen = document.getElementsByClassName('lanes')[2];


buttonGreen.addEventListener('click', calculo);
...
function calculo(){
    ...
    function definingBackgroundColor () {
        ...
        card.style.backgroundColor = "rgba(0,255,0, 0.349)";
    }
